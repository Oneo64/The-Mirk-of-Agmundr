# Magic
Magic is a mysterious, supernatural force that causes miracles and unexplained events. Seiðr, for example, is a type of shamanic magic used to predict things and bestow curses. Since there isn't a list of spells, I'll just list each moment where magic happened in the lore:
